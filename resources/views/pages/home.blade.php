    ...
    <section id="projects">
                    ...
                    <div class="info">
                        <div class="top">
                            ...
                            <div class="likeContainer glass">
                                <span class="likeCounter">14</span>
        ...
        <div id="projectGrid">
            @foreach(range(1, 9) as $index)
                <article x-data="{ isLiked{{ $index }}: false }">
                    <a href="/post" title="" alt="">
                        <div class="info">
                            <div class="top">
                                <h6>Browser extension</h6>
                                <div class="likeContainer" x-bind:class="{ 'liked': isLiked{{ $index }} }" x-on:click="isLiked{{ $index }} = !isLiked{{ $index }}">
