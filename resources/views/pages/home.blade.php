<x-front-layout>
    <div class="projects">
        ...
        <div class="flex gap-9">
            ...
            @php $index= 1; @endphp
                <a class="flex items-center p-1 dark:bg-[#1b1c2a] border border-[#282B3A] rounded-3xl relative {{ $index === 1 ? 'full' : 'basis-1/3' }} {{ $index === 1 ? '' : 'flex-col justify-between'}}" href="#" title="" alt="" class="project">
                    <div class="pl-6 pr-12 min-w-[50%]">
                        <h2 class="text-3xl font-bold">My Favorite Dogs</h2>
                        <p class="my-4">{{ __('Create a list of your favorite dog breeds and share it with your friends.') }}</p>
        ...
        <div class="flex gap-7 grid grid-cols-3 mt-7">
            @foreach(range(1, 8) as $index)
                ...
                <a class="flex flex-col items-center p-1 dark:bg-[#151621] border border-[#282B3A] rounded-3xl relative hover:scale-105 transition-transform" href="#" title="" alt="" class="project">
                    <div class="p-6">
                        <h2 class="text-xl font-bold mb-2">My Favorite Dogs</h2>
